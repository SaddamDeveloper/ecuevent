...
CREATE TABLE `city` (
  ...
  `status` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1=enabled, 2=disabled',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Guwahati', '1', NULL, '2020-04-08 17:43:45'),
(2, 'Nagaon', '1', NULL, '2020-04-08 17:43:52'),
(3, 'Barpeta', '1', NULL, '2020-04-08 17:43:58'),
(4, 'Dibrugarh', '1', NULL, '2020-04-08 17:45:44');
...
CREATE TABLE `commission_history` (
  ...
  `status` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1=credited, 2=Capping, 3=CutOFF',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(12, 3, 1, '900.00', '900.00 Income of Pair Number 1 is successfully credited to your wallet! ', '1', '2020-04-08 18:31:48', NULL),
(13, 4, 1, '900.00', '900.00 Income of Pair Number 1 is successfully credited to your wallet! ', '1', '2020-04-09 10:08:34', NULL),
(14, 1, 1, '900.00', '900.00 Income of Pair Number 1 is successfully credited to your wallet! ', '1', '2020-04-09 10:08:35', NULL);
...
(2, '5', '2020-03-17 08:33:53', '2020-04-11 10:35:08'),
(3, '7', '2020-03-17 08:33:53', NULL),
(5, '9', '2020-04-11 10:40:41', NULL);
...
(42, 'TN317542', '1', '1', '2020-03-20 13:19:36', '39', '2020-03-19 08:51:43', '2020-03-20 13:19:36'),
...
(47, 'VT677247', '1', '4', '2020-04-09 10:03:16', '40', '2020-03-19 08:51:44', '2020-04-09 10:03:16'),
(48, 'ID603248', '2', '4', '2020-04-09 10:03:16', NULL, '2020-03-19 08:51:44', '2020-04-09 10:03:16'),
(49, 'PA519049', '2', '4', '2020-04-09 10:03:16', NULL, '2020-03-20 13:19:21', '2020-04-09 10:03:16'),
(50, 'FX864250', '2', '4', '2020-04-09 10:03:16', NULL, '2020-03-20 13:19:21', '2020-04-09 10:03:16'),
(51, 'ZN259451', '2', '4', '2020-04-09 10:03:16', NULL, '2020-03-20 13:19:21', '2020-04-09 10:03:16'),
...
(61, 'NM942061', '2', NULL, NULL, NULL, '2020-04-09 10:02:04', NULL),
(62, 'LS150062', '2', NULL, NULL, NULL, '2020-04-09 10:02:04', NULL),
(63, 'AG314963', '2', NULL, NULL, NULL, '2020-04-09 10:02:04', NULL),
(64, 'WF537864', '2', NULL, NULL, NULL, '2020-04-09 10:02:04', NULL),
(65, 'IJ585465', '2', NULL, NULL, NULL, '2020-04-09 10:02:04', NULL);
...
CREATE TABLE `members` (
  ...
  `status` char(1) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '1=Active, 2=Deactive',
  `epin` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `document_status` char(1) COLLATE utf8mb4_unicode_ci DEFAULT '2' COMMENT '1=Verified, 2=Not Verified, 3=Rejected',
  `document_u_status` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '1=uploaded, 2=not uploaded',
  `policy_is_agree` char(1) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '1=agree, 2=Not Agree',
  `registered_by` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `members` (`id`, `member_id`, `name`, `email`, `password`, `mobile`, `gender`, `dob`, `total_pair`, `status`, `epin`, `nominee_relation`, `nominee_name`, `nominee_mobile`, `nominee_address`, `state`, `city`, `pin`, `address_proof_doc`, `address_proof_no`, `photo_proof`, `document_status`, `document_u_status`, `policy_is_agree`, `registered_by`, `created_at`, `updated_at`) VALUES
(1, 'EE000001', 'ECU EVENT', 'member@mail.com', '$2y$10$8wnMGsrTy9aFRY3RWoWh7OUik2I2d51vlmp4EEQuQvoK.25a72NCW', '12345678912', '1', '1995-06-15', NULL, '1', NULL, 'Father', 'ECU', '986969', 'Nagaon', 'Assam', 'Nagaon', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', NULL, '2020-04-09 21:00:32'),
(2, 'SH000002', 'Saddam Hussain', 'iamsaddamhussain99@gmail.com', '$2y$10$8wnMGsrTy9aFRY3RWoWh7OUik2I2d51vlmp4EEQuQvoK.25a72NCW', '8486935380', '1', '2020-04-10', NULL, '1', 'MS832943', 'Father', 'Nurul Islam', '4562452798789', 'Barpeta', 'Assam', 'Barpeta', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 13:35:59', '2020-04-09 21:01:53'),
(3, 'PD000003', 'Pranab Das', 'pranab@mail.com', '$2y$10$8wnMGsrTy9aFRY3RWoWh7OUik2I2d51vlmp4EEQuQvoK.25a72NCW', '123456234', '1', '2020-04-10', NULL, '1', 'GP181044', 'Father', 'Pran', '4562452', 'Delhi', 'Assam', 'Guwahati', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 13:36:58', '2020-04-09 21:03:15'),
(4, 'VN000004', 'Vishal Nag', 'vish@mail.com', '$2y$10$8wnMGsrTy9aFRY3RWoWh7OUik2I2d51vlmp4EEQuQvoK.25a72NCW', '86989787', '2', '2020-01-07', NULL, '1', 'EK802246', 'Brother', 'DP NAG', '8696896', 'Golaghat', 'Assam', 'Guwahati', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 13:37:45', '2020-04-09 21:04:33'),
(5, 'GC000005', 'Gulzar Ahmed Chowdhury', 'gulu@mail.com', '$2y$10$DbxrsumeO54tWxe1P5jbXOQZg.RtILLUwfOl6H3mixvyMsPct0JVG', '6869878798', '2', '2015-06-04', NULL, '1', 'TY505340', 'Father', 'Umm', '21313', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 13:39:04', '2020-04-09 21:05:51'),
(13, 'RC000013', 'Rashan Chabraia', 'dinu@mail.com', '$2y$10$FIIa0BdM69e4G9nqT2L4zeCTk4g5lAgZzQr7FmJYEVUw56Qxe.I2e', '12345678912', '1', '2020-04-10', NULL, '1', 'MH229939', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 13:46:01', '2020-04-09 20:51:35'),
(14, 'HX000014', 'Huxxen Xasa', 'dinu@mail.com', '$2y$10$fLks/NC6wt9d2OtTWgOSmuUFBhH57Pc1yz5wAaft7itkUVtmJ1XYW', '12345678912', '1', '2020-04-10', NULL, '1', 'XC171538', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 13:50:17', '2020-04-09 20:51:35'),
(31, 'MS000031', 'Saddam', 'dinu@mail.com', '$2y$10$hYy7BP0tqYUuAHGc84hQm.h507bSJPsHwlQ3aoE8hIAi6QfwDYSZC', '12345678912', '1', '2020-04-10', NULL, '1', 'NV521036', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 14:04:52', '2020-04-09 20:58:47'),
(32, 'JD000032', 'Jintu Dutta', 'dinu@mail.com', '$2y$10$srtu9gKCGPEzGw5XTqR.duppPprErBm6uNQQiO9kkZEacXE5F1Ky.', '12345678912', '1', '2020-04-10', NULL, '1', 'CO649235', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 14:12:08', '2020-04-09 20:51:35'),
(38, 'SD000038', 'Saidul Dai', 'dinu@mail.com', '$2y$10$jQUtVgy8Uz2581ZNMiTUFuv6sYvfM5wJ71JzEareIeX9YL9rO9use', '12345678912', '1', '2020-04-10', NULL, '1', 'NX741337', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'ECU EVENT', '2020-03-20 14:16:38', '2020-04-09 20:51:35'),
(39, 'DM000039', 'Dinu  Maria', 'dinu@mail.com', '$2y$10$QVrukm7cpwboM4/Nfcz3ae6aHQY6VkgMTwostZJVUQpUBuBx5eaGa', '12345678912', '1', '2020-04-10', NULL, '1', 'TN317542', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, '1432784578d26edfe04bbfe9ec679d591.jpg', '1234', '1432784578d26edfe04bbfe9ec679d592.PNG', '1', '1', '1', 'ECU EVENT', '2020-04-08 18:31:47', '2020-04-10 11:00:43'),
(40, 'RP000040', 'Rani Paul', 'rani@mail.com', '$2y$10$L4lzcPc8vTLKL/GNDAsWMe6ADsXKXeFfQ00K7o8N/XF5UIFAE.yAC', '12345678912', '1', '2020-04-10', NULL, '1', 'VT677247', 'Father', 'Senu Maria', '4562452', 'Delhi', 'Assam', 'Dibrugarh', 781301, NULL, NULL, NULL, '2', '2', '1', 'Vishal  Nag', '2020-04-09 10:08:33', '2020-04-12 17:44:38');
...
(8, 39, 'TN317542', 'Churidar with Bag', '31f00e20dbcf5088157080474fdb69c51.jpg', NULL, '2020-04-08 18:32:43', NULL);
...
(53, 3, '2020-04-08 18:31:48', NULL),
(54, 4, '2020-04-09 10:08:34', NULL),
(55, 1, '2020-04-09 10:08:34', NULL);
...
(18, '2020_04_08_173748_create_state_table', 16),
(19, '2020_04_08_174054_create_city_table', 17);
...
(1, 'Assam', '1', NULL, '2020-04-08 17:43:29');
...
(1, 1, 2, 3, NULL, 1, 0, 0, 6, 5, 5, '2020-03-11 07:49:25', '2020-04-09 10:08:35'),
(2, 2, 4, 5, 1, 1, 2, 0, 4, 1, 1, '2020-03-20 13:35:59', '2020-04-09 10:08:34'),
(3, 3, 39, 13, 1, 1, 0, 1, 1, 3, 1, '2020-03-20 13:36:58', '2020-04-08 18:31:48'),
(4, 4, 14, 40, 2, 1, 0, 0, 2, 1, 1, '2020-03-20 13:37:45', '2020-04-09 10:08:34'),
...
(39, 39, NULL, NULL, 3, 1, 0, 0, 0, 0, 0, '2020-04-08 18:31:47', NULL),
(40, 40, NULL, NULL, 4, 4, 0, 0, 0, 0, 0, '2020-04-09 10:08:33', NULL);
...
(1, 1, '2700.00', '1', '2020-03-19 06:13:51', NULL),
(2, 2, '900.00', '1', '2020-03-20 13:35:59', NULL),
(3, 3, '900.00', '1', '2020-03-20 13:36:58', NULL),
(4, 4, '900.00', '1', '2020-03-20 13:37:45', NULL),
...
(39, 39, '0.00', '1', '2020-04-08 18:31:48', NULL),
(40, 40, '0.00', '1', '2020-04-09 10:08:33', NULL);
...
(7, 3, 3, '1', '900.00', '900.00', '900.00 Income of Pair Number 1 is successfully credited to your wallet! ', '2020-04-08 18:31:48', NULL),
(8, 4, 4, '1', '900.00', '900.00', '900.00 Income of Pair Number 1 is successfully credited to your wallet! ', '2020-04-09 10:08:34', NULL),
(9, 1, 1, '1', '900.00', '2700.00', '900.00 Income of Pair Number 1 is successfully credited to your wallet! ', '2020-04-09 10:08:35', NULL);
