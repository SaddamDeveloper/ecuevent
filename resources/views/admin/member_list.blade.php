         ...
         $(function () {
            var table = $('#member_list').DataTable({
                ...
                columns: [
                    ...
                    {data: 'document_verify', name: 'document_verify' ,searchable: true},                 
                    {data: 'document_status', name: 'document_status' ,searchable: true},                 
                    {data: 'registered_by', name: 'registered_by' ,searchable: true},                 
